...
| <a name="input_kafka_version"></a> [kafka\_version](#input\_kafka\_version) | The Kafka version to use. | `string` | `"2.8"` | no |
...
| <a name="input_resource_preset_id"></a> [resource\_preset\_id](#input\_resource\_preset\_id) | The resource preset ID. | `string` | `"s2.micro"` | no |
